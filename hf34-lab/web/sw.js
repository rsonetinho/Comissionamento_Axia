const CACHE='kratos-hf34-lab-v1';
const ASSETS=['./','index.html','styles.css','app.js','manifest.webmanifest','icon.svg','seed/part1.txt','seed/part2.txt','seed/part3.txt','seed/part4.txt'];
